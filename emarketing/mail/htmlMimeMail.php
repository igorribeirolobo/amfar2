...
function sendMail($mailTo, $nameFrom, $mailFrom, $subject, $body) {
	// parte text/html		
	$mTop = "<html><head><title>AMF - Associação Mineira de Farmacêuticos</title>\r\n";
	$mTop .= "	<style>\r\n";
	$mTop .= "		#mailFotter{float:left;width:600px;background:#A4CCD5;text-align:center\r\n";
	$mTop .= "		#mailFotter a {font:9pt bolder Arial, verdana;color:#fe9900;text-decoration:none}\r\n";
	$mTop .= "		#mailFotter a:hover{color:#f60;text-decoration:underline}\r\n";
	$mTop .= "	</style>\r\n";
	$mTop .= "</head>\r\n\r\n";
	$mTop .= "<body topmargin=0 leftmargin=0>\r\n";
	$mTop .= $body;
	$mTop .= "<div class=mailFotter><a href='http://www.amfar.com.br'/>:: A M F ::</a></div>";
