...
//if($parcela > 1){
	$dadosboleto["instrucoes"] .= "- Sr. Caixa, não receber após o dia $dataLimite<br />-&nbsp;&nbsp;Após o vencimento, cobrar multa de 2% mais juros de 0,03% ao dia.";	
//	}
...
$dadosboleto["instrucoes2"] = "-&nbsp;Em caso de dúvidas entre em contato com secretaria@amfar.com.br";
