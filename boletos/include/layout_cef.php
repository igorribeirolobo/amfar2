...
<table width=666 cellspacing=5 cellpadding=0 border=0 align=Default>
  <tr>
    <td width=41><IMG SRC="<?= $dadosboleto["logoEmpresa"]?>"></td>
    <td class=ti width=455><? echo $dadosboleto["identificacao"]; ?> <? if ($dadosboleto["cpf_cnpj"] !="") echo $$dadosboleto["cpf_cnpj"];?><br>
	<? echo $dadosboleto["cpf_cnpj"]; ?> - Telefone: <?= $dadosboleto["telefone"]?><br>
...
de pagamento</td><td class=ct valign=top width=7 height=13><img height=13 src=imagens/1.gif width=1 border=0></td><td class=ct valign=top width=180 height=13>Vencimento</td></tr><tr><td class=cp valign=top width=7 height=12><img height=12 src=imagens/1.gif width=1 border=0></td><td class=cp valign=top width=472 height=12>PAGAR 
PREFERENCIALMENTE NAS CASAS LOTÉRICAS ATÉ O VALOR LIMITE.</td><td class=cp valign=top width=7 height=12><img height=12 src=imagens/1.gif width=1 border=0></td><td class=cp valign=top align=right width=180 height=12> 
  <span class="campo">
  <?=$dadosboleto["data_vencimento"]?>
  </span></td>
...
processam.</td><td class=ct valign=top width=7 height=13> <img height=13 src=imagens/1.gif width=1 border=0></td><td class=ct valign=top width=180 height=13>Nosso 
