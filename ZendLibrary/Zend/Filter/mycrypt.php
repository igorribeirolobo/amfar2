...
class Zend_Filter_MyCrypt {
    ...
    protected function SetMode($mode) {
        Zend_Filter_MyCrypt::IsSupportedMode($mode) && $this->mode = (int)$mode;
    }
    ...
    protected function SetHash($hash) {
        Zend_Filter_MyCrypt::IsSupportedHash($hash) && $this->hash = (int)$hash;
    }
    ...
    public static function IsSupportedMode($mode) { 
        return in_array($mode, Zend_Filter_MyCrypt::SupportedModes());
    }
    ...
    public static function IsSupportedHash($hash) { 
        return in_array($hash, Zend_Filter_MyCrypt::SupportedHashes());
    }
