...
$html="<table width='100%' cellPadding=2 cellSpacing=2>
	...
	<tr>
		<td align='center' colspan='2'>
			<a class=dst href='eventos/folderMinasResiduos.jpg' target='_evento'>
				<img src='eventos/minasResiduos.jpg' border='0'/><br />
				Vagas limitadas - Inscrições gratuitas até 12/11/2010<br />Clique para detalhes</a>
			<hr size='1'>
		</td>
	</tr>";
