...
//		die("Acesso não autorizado. Seu IP ". $_SERVER["REMOTE_ADDR"] . " foi capturado e será enviado aos orgãos competentes por tentativa de ataque a este site!");
	...
	if ($rsCadastro)	{
			...
			<table border=0 cellspacing=2 cellpadding=2 width=100% />
				...
				<tr>
					<td colspan=2 class=tleft>Olá <b>$rsCadastro->nome</b>, 
						você solicitou que fosse enviada sua senha de acesso ao nosso site.<br><br>
						A sua senha para acesso é:&nbsp;&nbsp;<font color=006666><b>$rsCadastro->senha</b></font>.<br><br>
		...
		$mailsend = sendMail($rsCadastro->email,'AMF|Cadastro',$webmaster,'AMF|Envio de Senha', $body, "ENVIO DE SENHA");
		?>
		...
		<?	if ($mailsend == 'E-mail enviado com sucesso')	{	?>
			<tr>
				<td align="center" height="30">Caro <b><font size=2><?= $nome ?></font></b>,</td></tr>
					<tr>
						<td align="center" height="30">					
							Sua senha foi enviada para o e-mail constante em seu cadastro.<br><br>
		...
		<table border="0" cellspacing="1" cellpadding="1">
			<tr>
				<td align=center colspan=2 bgcolor="#efefef">
					<p align="center">
						...
						para que a mesma seja enviada para o email constante 
						em nosso cadastro.</p>
			<tr>
			...
			<tr>
				<td align=center colspan=2>
					<input type="submit" name="btForgot" id="btSend" value="Envia Senha"></td>
			</tr>
		</table>
	</form>
	<br /><?
...
*/				
	echo"			
		<tr><td><p align=center><br/>
			<img src='css/h_arrow.gif' align='absMiddle'>&nbsp; 
			Altere seu cadastro se necessário!<br></tr>
	</table>";	
	}	// else do if (user)
...
?>
				<div id="inscricaoOnLine"><a name='inscricao'><br />
					<p align=center><span style="color:#336699">Associados têm desconto de 10% sobre o total para pagamento à vista e 5% para parcelado.</span><br/><b style='color:#336699'><a href="javascript:void(null)" onclick="opener.location.href ='index.php?lnk=80&flag=2'">SEJA UM ASSOCIADO.</a></b>
