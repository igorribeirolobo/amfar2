...
String.prototype.formatCEP = function() {var s = this.replace(/[' '-./ \t]/,'');if(s.length==8)return s.substr(0,5)+'-'+s.substr(5,3);else return s;}
...
String.prototype.ucFirst=function(){var t=this;var fst=t.substr(0,1).upper();t.charAt[0]=fst;return t;}
String.prototype.filled=function(id){
	alert('id='+this.id);
	return true;
	}
