...
class IndexController extends Zend_Controller_Action{
	...
	function preDispatch()
		...
		//$this->fc->debug($auth);
		if ($auth->hasIdentity() && $this->view->user->origem != "AMF") {
	...
	function indexAction(){	
		...
		$this->view->eventos = $this->fc->dbReader($this->db, "SELECT TOP 10 id, CONVERT(CHAR(10),data,103) AS strdata, titulo FROM eventos ORDER BY data DESC", true);
		}
