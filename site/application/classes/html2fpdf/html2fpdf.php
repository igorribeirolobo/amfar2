...
require_once(dirname(__FILE__) . '/htmltoolkit.php');
...
//! @desc The footer is printed in every page!
	...
	$this->Cell(0,10,'Radiofone do Brasil Ltda - http://www.radiofone.com.br',0,0,'C');
	$this->SetTextColor(0);
...
*/
  ...
  $ind = 0;
   ...
   // echo "this->basepath=$this->basepath path=$path";
