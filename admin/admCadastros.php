...
?>
<style>
	#busca td{padding:2px 4px;border:1px solid silver;}
	#busca th{text-align:center;background:url(images/title_bg.jpg);color:#fff;font-weight:bolder;height:20px}
	.newReg{cursor:pointer}
...
<form  name="myForm" id="myForm" method="POST" action="" style="width:100%; margin:0">
	<table id="busca" border="0" cellpadding="0" cellspacing="0" width="100%">
		<tr>
			<th>Selecione o grupo:&nbsp; 
			...
			<th style="text-align:left">ou digite o nome ou parte do nome ou CPF:&nbsp;
				<input type="text" size="30" name="key" id="key" value="<?=$_POST['key']?>">
				<input type="button" name="btSearch" id="btSearch" value=" OK ">
			</th>
			<th>Ordem por nomes. Clique no ID para alterar</th>
		</tr>
	</table>
</form>
...
<table id="list" border="0" cellspacing="2" cellpadding="2">
	<thead>
		<tr>
			...
			<th class="header">Nome/Empresa</th>
