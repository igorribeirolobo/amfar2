...
(function($) {
	...
	$.fn.lightBox = function(settings) {
		...
		settings = jQuery.extend({
			...
			imageLoading:			$_imageLoading, // (string) Path and the name of the loading icon
			imageBtnPrev:			$_imageBtnPrev,	  // (string) Path and the name of the prev button image
			imageBtnNext:			$_imageBtnNext,	  // (string) Path and the name of the next button image
			imageBtnClose:			$_imageBtnNext,	  // (string) Path and the name of the close btn
